...
while True:
    ...
    if pilihan in ["1","2","3"]:
        ...
        nim_terpintar = max(nilai.keys(), key=lambda n: rata_mahasiswa(n))
        nama_terpintar = mahasiswa[nim_terpintar]
        nilai_terpintar = rata_mahasiswa(nim_terpintar)
        ...
        print(f"Mahasiswa Terpintar: {nama_terpintar} (Nilai: {round(nilai_terpintar,2)})")
